...
class _UsernameScreenState extends State<UsernameScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await Provider.of<ChatProvider>(context, listen: false).setUsername(name);
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'This name will show on your profile, progress, and community posts.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 14,
                            ...
                            children: [
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  helperText:
                                      'Auto-filled from your email. You can change it.',
                    ...
                    Center(
                      child: Text(
                        'Your username links your progress across all devices.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 12,
